...
@register_model
def compo_videomae_adapter_vit_base_patch16_224(pretrained=False, **kwargs):
    ...
    return model
@register_model
def videomae_adapter_vit_base_patch16_224(pretrained=False, **kwargs):
    model = STCrossTransformer(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, mlp_ratio=4, qkv_bias=True,
...
@register_model
def compo_videomae_vit_base_patch16_224(pretrained=False, **kwargs):
    model = STCrossTransformer(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, mlp_ratio=4, qkv_bias=True,
